...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        colors=[[NSMutableArray alloc]initWithObjects:[UIColor blackColor],[UIColor blueColor],[UIColor redColor],[UIColor greenColor],[UIColor whiteColor], nil];
...
//    [NSString stringWithFormat:@"%0.0f", [touch locationInView:touch.view].x];
//    [NSString stringWithFormat:@"%0.0f", [touch locationInView:touch.view].y];
//    NSLog(@"%@,%@",[NSString stringWithFormat:@"%0.0f", [touch locationInView:touch.view].x],[NSString stringWithFormat:@"%0.0f", [touch locationInView:touch.view].y]);
}
//当手指离开屏幕时候
